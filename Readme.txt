...
Tags: woocommerce, customize, customization, customizer, modify, modification, editor, gui, drag and drop
...
Introduces a visual drag&drop editor to customize by add/exchange/drop position 
of any built-in as well as custom built elements, in a single product page as well as in an archive shop page which are the main pages that 
WooCommerce users tend to modify. 
...
In addition there is a Custom content builder which enables adding a simple button or a link or a any complex Html tag (which you can 
...
Common elements like Button and Link are available for common users but any Html Markup
is also available by the Custom Content Builder.  
...
Modify Screanshot
= 1.4.2 =
Modify Screan and banner
= 1.4.1 =
Modify Readme file
= 1.4 =
Add screenshot and Faqs
= 1.3 =
Readme updating
= 1.2 =
= 1.1 =
